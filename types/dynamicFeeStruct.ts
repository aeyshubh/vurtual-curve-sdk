...
export function getDynamicFeeStructEncoder(): Encoder<DynamicFeeStructArgs> {
...
export function getDynamicFeeStructDecoder(): Decoder<DynamicFeeStruct> {
...
export function getDynamicFeeStructCodec(): Codec<
