...
export function getDynamicFeeParametersEncoder(): Encoder<DynamicFeeParametersArgs> {
...
export function getDynamicFeeParametersDecoder(): Decoder<DynamicFeeParameters> {
...
export function getDynamicFeeParametersCodec(): Codec<
