...
export function getClaimFeeOperatorEncoder(): Encoder<ClaimFeeOperatorArgs> {
...
export function getClaimFeeOperatorDecoder(): Decoder<ClaimFeeOperator> {
...
export function getClaimFeeOperatorCodec(): Codec<
